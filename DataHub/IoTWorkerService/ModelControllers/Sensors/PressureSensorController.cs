...
namespace DbCommunicationLib.Controller.Sensors
{
    class PressureSensorController: DoubleSensorController
    {
        ...
        public override SensorEventControllerBase CreateEventController(string sensorValue) => new PressureSensorEventController(CreateSensorEvent(sensorValue), DbContext);
    }
}
